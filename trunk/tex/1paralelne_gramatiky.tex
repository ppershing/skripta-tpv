...
%%% {{{
    ...
    je bez-$\varepsilon$.\fixme{Znamena to, ze nema epilon alebo ze
...
\begin{dokaz}
    ...
    \item $L$ je nekonečný: $\forall i\med 1\leq i\leq m$ nech
        ...
        každý symbol buď na $\varepsilon$ (a teda sa ho zbavíme), alebo ho
...
\begin{dokaz}
    ...
    $\varepsilon$) originálneho stromu odvodenia.
